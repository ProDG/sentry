...
DATABASES = {
    'default': {
        ...
        'NAME': env_str('POSTGRES_DB', 'sentry'),
        'USER': env_str('POSTGRES_USER', 'sentry'),
        'PASSWORD': env_str('POSTGRES_PASSWORD', ''),
        'HOST': env_str('POSTGRES_HOST', 'sentry'),
...
SENTRY_WEB_PORT = env_int('SENTRY_PORT', 9000)
SENTRY_WEB_OPTIONS = {
    'workers': env_int('SENTRY_WORKERS', 4)
}
